...
Route::group(['middleware' => ['jwt.verify:admin']], function () { //untuk hak akses admin dan petugas
    ...
    //REPORT
    Route::post('pengaduan/report/{limit}/{offset}', [PengaduanController::class, 'findReport']); //get all
    Route::get('pengaduan/report/{limit}/{offset}', [PengaduanController::class, 'getReport']); //get all
    Route::get('pengaduan/report/{id_pengaduan}', [PengaduanController::class, 'getReport']); //get all
...
Route::group(['middleware' => ['jwt.verify:admin,petugas']], function () {
    ...
    Route::get('pengaduan/tanggapan/{id_pengaduan}', [TanggapanController::class, 'getById']); //memasukan tanggapan
...
Route::group(['middleware' => ['jwt.verify:masyarakat']], function () { //untuk hak akses masyarakat
    ...
    // Route::get('pengaduan/{id_pengaduan}', [PengaduanController::class, 'getById']); //get all
    Route::get('masyarakat/pengaduan/{id_pengaduan}/{limit}/{offset}', [PengaduanController::class, 'getById']); //get all
    ...
    Route::get('masyarakat/kategori/{limit}/{offset}', [KategoriController::class, 'getAll']); //get all
});